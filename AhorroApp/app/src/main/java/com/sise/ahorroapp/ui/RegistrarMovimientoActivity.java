...
public class RegistrarMovimientoActivity extends AppCompatActivity {
    ...
    private void registrarMovimiento() {
        ...
        Movimiento nuevoMovimiento = new Movimiento(tipo, monto, descripcion, fecha);
        ...
        movimientoService.guardarMovimiento(nuevoMovimiento).enqueue(new Callback<Movimiento>() {
            ...
            public void onResponse(Call<Movimiento> call, Response<Movimiento> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(RegistrarMovimientoActivity.this, "Error al registrar", Toast.LENGTH_SHORT).show();
                }
            }
